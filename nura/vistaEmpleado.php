...
<div class="modal fade bd-example-modal-lg " id="modalSeeEmpleado" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
         <h5 class="modal-title" id="empleadoLabel" >Vista Empleado</h5>
        <i class="far fa-times-circle" onclick="closeSeeEmpleado()" style="cursor: pointer; font-size:20px"></i>
       </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" aria-label="Close" style="font-weight: bold"  onclick="closeSeeEmpleado()">
                    CERRAR
                  </button>
            </div>
        </div>
