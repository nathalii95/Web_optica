<?php  
    ...
    $query=" SELECT * 
    FROM enfermedad  where estado = '1'
...
<body class="adminbody">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="breadcrumb-holder">
                                <h1 class="main-title float-left">Enfermedad</h1>
                                <ol class="breadcrumb float-right">
                                    <li class="breadcrumb-item">Inicio</li>
                                    <li class="breadcrumb-item active">Enfermedad</li>
                                </ol>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3><i class="fas fa-disease"></i> Listado de Enfermedades</h3>
                                </div>
                                <div class="card-body">
                                <button type="button" class="btn btn-warning" onclick="newEnfermedad()" >Nuevo </button><br><br>
                               <?php include ('nuevoEnfermedad.php');?> 
                                 <?php include ('modificarEnfermedad.php');?> 
                                    ...
                                    style="text-align: center; font-weight: bold;width:100%" >
                                        <thead>
                                            <tr style="background:#222222;color:white; text-align: center; ">
                                                ...
                                                <th>#</th>
                                                <th  style="visibility:collapse;display: none;"  >ID Enfermedad</th>
                                                <th>Enfermedad</th>
                                                <th>Acción</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <?php  while($row=$resultado->fetch_assoc()){ ?>
                                            <tr>
                                                ...
                                                <td style="visibility:collapse;display: none;" style="width: 5%;"><?php echo $row['id_enfermedad'];?></td>
                                                <td class="text-center" style="width: 5%;"><?php echo $row['nombre_enfermedad'];?></td>
                                                <td class="text-center" style="width: 5%;">
                                                    <button type="button" class="btn btn-info editbtn" style="font-size: 9px;" data-toggle="tooltip" title="Editar Paciente" onclick="editEnfermedad()" > <i class="far fa-edit" style="font-size: 13px;"></i></button>
                                                    <button type="button" class="btn btn-danger deletebtn" style="font-size: 9px;" data-toggle="tooltip" title="Eliminar Paciente"> <i class="fas fa-trash" style="font-size: 13px;"></i></button>   
                                               </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
    ...
    <script src="assets/js/enfermedad_datatable.js"></script>
