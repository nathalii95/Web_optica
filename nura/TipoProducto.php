...
<body class="adminbody">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="breadcrumb-holder">
                                <h1 class="main-title float-left">Tipo Producto</h1>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3><i class="fab fa-product-hunt"></i> Listado de Tipo Producto</h3>
                                </div>
                                <div class="card-body">
                                <button type="button" class="btn btn-warning" onclick="newTipoProduct()" >Nuevo </button><br><br>
                               <?php include ('nuevoTipoProducto.php');?> 
                                 <?php include ('modificarTipoProducto.php');?> 
                                    ...
                                    style="text-align: center; font-weight: bold;width:100%" >
                                        <thead>
                                            <tr style="background:#222222;color:white; text-align: center; ">               
                                                <th>#</th>
                                                <th style="visibility:collapse;display: none;"  >ID Producto</th>
                                                <th>Tipo Producto</th>
                                                <th>Acción</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <?php  while($row=$resultado->fetch_assoc()){ ?>
                                            <tr>
                                                ...
                                                <td style="visibility:collapse;display: none;" style="width: 5%;"><?php echo $row['id_tipo_producto'];?></td>
                                                <td class="text-center" style="width: 5%;"><?php echo $row['tipo_nombre'];?></td>
                                                <td class="text-center" style="width: 5%;">
                                                    <button type="button" class="btn btn-info editbtn" style="font-size: 9px;" data-toggle="tooltip" title="Editar Tipo Producto" onclick="editTipoProducto()" > <i class="far fa-edit" style="font-size: 13px;"></i></button>
                                                    <button type="button" class="btn btn-danger deletebtn" style="font-size: 9px;" data-toggle="tooltip" title="Eliminar Tipo Producto"> <i class="fas fa-trash" style="font-size: 13px;"></i></button>   
                                               </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
    ...
    <script src="assets/js/tipoProducto_datatable.js"></script>
    <script src="assets/js/modals.js"></script>
    <script src="jsValidacion/tipoProducto.js"></script>
    <!-- App js -->
